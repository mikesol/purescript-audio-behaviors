                    ...
                    for (var i = 0; i < instructions.length; i++) {
                      ...
                      if (c.constructor.name == "DisconnectFrom") {
                        ...
                        for (var j = 0; j < c.value0.length; j++) {
                          generators[c.value0[j].value1] =
                            old[c.value0[j].value0];
                        }
                        ...
                        generators[c.value0] =
                          c.value1.constructor.name == "Speaker$prime$prime"
                            ...
                            : c.value1.constructor.name ==
                              "Bandpass$prime$prime"
                            ? context.createBiquadFilter()
                            : c.value1.constructor.name ==
                              "Lowshelf$prime$prime"
                            ? context.createBiquadFilter()
                            : c.value1.constructor.name ==
                              "Highshelf$prime$prime"
                            ? context.createBiquadFilter()
                            ...
                            ? context.createBiquadFilter()
                            : c.value1.constructor.name ==
                              "Highpass$prime$prime"
                            ? context.createBiquadFilter()
                            : c.value1.constructor.name ==
                              "DynamicConvolver$prime$prime"
                            ? context.createConvolver()
                            : c.value1.constructor.name ==
                              "Convolver$prime$prime"
                            ? context.createConvolver()
                            : c.value1.constructor.name ==
                              "DynamicsCompressor$prime$prime"
                            ? context.createDynamicsCompressor()
                            : c.value1.constructor.name ==
                              "SawtoothOsc$prime$prime"
                            ? context.createOscillator()
                            : c.value1.constructor.name ==
                              "TriangleOsc$prime$prime"
                            ? context.createOscillator()
                            : c.value1.constructor.name ==
                              "PeriodicOsc$prime$prime"
                            ? context.createOscillator()
                            : c.value1.constructor.name ==
                        ...
                        for (
                          ...
                          var nowBuffering = myArrayBuffer.getChannelData(
                            channel
                          );
